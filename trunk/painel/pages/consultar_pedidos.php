...
$(function () {
	$('#inserir').click(function(){
		...
		location.href = "../pages/manter_pedidos.php";
...
function editar (item) {
	location.href = "../pages/manter_pedidos.php?item="+ item;
}
function excluir() {
			...
			<div class="borda">
				...
				<table cellpadding="0" cellspacing="1" class="list">
					<tr>
						...
						<td class='table_title' width="15%" align='center'>ID Pedido</td>
						<td class='table_title' width="65%">ID Cliente</td>
					...
					<?
						...
						foreach($response as $obj) {
							echo "<tr>";
							echo "	<td class='td_item' align='center'><input type='checkbox' name='item' value='". $obj->getid_pedido() ."'></td>";
							echo "	<td align='center'>". $obj->getid_pedido() ."</td>";
							echo "	<td>". $obj->getid_cliente() ."</td>";
