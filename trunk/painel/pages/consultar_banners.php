			...
			<div class="borda">
				...
				<table cellpadding="0" cellspacing="1" class="list">
					<tr>
						...
						<td class='table_title' width="15%" align='center'>ID Banner</td>
					...
					<?
						...
						foreach($response as $obj) {
							echo "<tr>";
							echo "	<td class='td_item' align='center'><input type='checkbox' name='item' value='". $obj->getid_banner() ."'></td>";
							echo "	<td align='center'>". $obj->getid_banner() ."</td>";
