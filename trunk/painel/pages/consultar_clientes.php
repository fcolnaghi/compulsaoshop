...
$(function () {
	$('#inserir').click(function(){
		...
		location.href = "../pages/manter_clientes.php";
...
function editar (item) {
	location.href = "../pages/manter_clientes.php?item="+ item;
}
function excluir() {
			...
			<div class="borda">
				...
				<table cellpadding="0" cellspacing="1" class="list">
					<tr>
						...
						<td class='table_title' width="15%" align='center'>ID Cliente</td>
						<td class='table_title' width="65%">Nome Cliente</td>
					...
					<?
						...
						foreach($response as $obj) {
							echo "<tr>";
							echo "	<td class='td_item' align='center'><input type='checkbox' name='item' value='". $obj->getid_cliente() ."'></td>";
							echo "	<td align='center'>". $obj->getid_cliente() ."</td>";
